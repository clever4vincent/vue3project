...
export const magics = {
  ...
  553: (i) => `<div>所有混沌法术主动技能石等级 +${i}</div>`,
  554: (i) => `<div>所有闪电法术主动技能石等级 +${i}</div>`,
  555: (i) => `<div>所有火焰法术主动技能石等级 +${i}</div>`,
  556: (i) => `<div>所有冰霜法术主动技能石等级 +${i}</div>`,
  557: (i) => `<div>所有物理主动法术技能石等级 +${i}</div>`,
  558: (i) => `<div>所有火焰主动技能石等级 +${i}</div>`,
  559: (i) => `<div>所有冰霜主动技能石等级 +${i}</div>`,
  560: (i) => `<div>所有闪电主动技能石等级 +${i}</div>`,
  561: (i) => `<div>所有物理主动技能石等级 +${i}</div>`,
  562: (i) => `<div>所有混沌主动技能石等级 +${i}</div>`,
  563: (i) => `<div>所有主动技能石等级 +${i}</div>`,
};
const abs = (value) => {
